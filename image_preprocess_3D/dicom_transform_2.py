...
#------------------------------------------------------------------------
input_folder="D:/Ultrasound_data/Classified_folder/06_norm_nii_N/"
output_folfer="D:/Ultrasound_data/Classified_folder/07_3D_nii_N/"
    ...
    for dirpath, dirnames, filenames in os.walk(root_dir):
        for filename in filenames:
            if filename.endswith(".nii.gz"):
                ...
                data = img.get_fdata()
                data_new = data[..., :3]  # keep only first three dimensions
