...
from testing.look_up import look_up_option
...
class ResNetBlock(nn.Module):
    ...
    def __init__(
        ...
        conv_type: Callable = Conv
        norm_type: Callable = Norm
...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        norm_type: type[nn.BatchNorm1d | nn.BatchNorm2d | nn.BatchNorm3d] = Norm

        Poolmax=nn.MaxPool3d
        Poolavg=nn.AdaptiveAvgPool3d
        #pool_type: type[nn.MaxPool1d | nn.MaxPool2d | nn.MaxPool3d] = Pool[Pool.MAX, spatial_dims]
        #avgp_type: type[nn.AdaptiveAvgPool1d | nn.AdaptiveAvgPool2d | nn.AdaptiveAvgPool3d] = Pool[Pool.ADAPTIVEAVG, spatial_dims]
        pool_type: type[nn.MaxPool1d | nn.MaxPool2d | nn.MaxPool3d] = Poolmax
        avgp_type: type[nn.AdaptiveAvgPool1d | nn.AdaptiveAvgPool2d | nn.AdaptiveAvgPool3d] = Poolavg
    ...
    def _downsample_basic_block(self, x: torch.Tensor, planes: int, stride: int, spatial_dims: int = 3) -> torch.Tensor:
        ...
        out:torch.Tensor = nn.AvgPool3d(kernel_size=1, stride=stride)(x)
